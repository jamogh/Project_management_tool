        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          ...
          <div class="navbar-collapse collapse" id="navbarNav">
              <ul class="navbar-nav ml-auto">
                  <li class="nav-item">
                      <a class="nav-link" href="STUDENT/project.php">Project</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="STUDENT/skill.php">View Skill Matrix</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="STUDENT/mail.php">Mail</a>
                  </li>
                  <li class="nav-item">
